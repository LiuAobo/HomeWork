...
import com.example.newlogin.bean.UserInfo;
import com.example.newlogin.datebase.UserDBHelper;
import com.example.newlogin.util.DateUtil;
import com.example.newlogin.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990026 刘翱博"};
